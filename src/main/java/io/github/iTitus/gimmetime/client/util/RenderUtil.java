...
public class RenderUtil {
	...
	public static final FontRenderer fontRendererer = Minecraft.getMinecraft().fontRenderer;
	...
	private static void drawNumbers(double x, double y, double radius) {
		...
		fontRendererer.drawString(hour, (int) (x - (fontRendererer.getStringWidth(hour) / 2) + 1),
				(int) (y - radius - fontRendererer.FONT_HEIGHT), ConfigHandler.color);

		hour = "" + TimeUtil.convertToAMPMIfNecessary(TimeUtil.isPM() ? 15 : 3);
		fontRendererer.drawString(hour, (int) (x + radius + 1),
				(int) (y - (fontRendererer.FONT_HEIGHT / 2)), ConfigHandler.color);

		hour = "" + TimeUtil.convertToAMPMIfNecessary(TimeUtil.isPM() ? 18 : 6);
		fontRendererer.drawString(hour, (int) (x - (fontRendererer.getStringWidth(hour) / 2)), (int) (y
				+ radius + 1), ConfigHandler.color);

		hour = "" + TimeUtil.convertToAMPMIfNecessary(TimeUtil.isPM() ? 21 : 9);
		fontRendererer.drawString(hour, (int) (x - radius - fontRendererer.getStringWidth(hour)),
				(int) (y - (fontRendererer.FONT_HEIGHT / 2)), ConfigHandler.color);
