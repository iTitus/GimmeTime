...
public class GuiIntSliderButton extends GuiButton {
	...
	protected void mouseDragged(Minecraft mc, int x, int y) {
		...
		drawTexturedModalRect((int) (xPosition + (((float) position / maxPos) * (width - 8))), yPosition, 0, 66, 4, 20);
		drawTexturedModalRect((int) (xPosition + (((float) position / maxPos) * (width - 8)) + 4), yPosition, 196, 66, 4, 20);
	}
